define(["require", "exports", "knockout", "underscore", "promise", "./mapping", "./query", "koutils/underscore", "koutils/utils", "koutils/extenders"], function(require, exports, ko, _, Promise, mapping, query, underscore, utils) {
    ...
    var dataViewFunctions = {
        ...
        saveChanges: function () {
            var changes = this.getChanges(), set = this.set, states = mapping.entityStates, promises = _.union(_.map(changes[1 /* added */], function (e) {
                return set._remoteCreate(e);
            }), _.map(changes[2 /* modified */], function (e) {
                return set._remoteUpdate(e);
            }), _.map(changes[3 /* removed */], function (e) {
                return set._remoteRemove(e);
            }));
