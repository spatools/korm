...
export class Filter {
    ...
    constructor(field: any, operator?: any, value?: any) {
        ...
        this.operator = utils.createObservable<string>(operator);
...
export class FunctionFilter extends Filter {
    ...
    constructor(fn: any, field: any, args?: any, operator?: any, value?: any) {
        this.fn = utils.createObservable<string>(fn);
        this._field = utils.createObservable<string>(field);
...
export class Ordering {
    ...
    public toSortFunction(): (item1: any, item2: any) => number {
        ...
        return function (item1, item2) {
            ...
            if (_.isString(itemField1)) { itemField1 = itemField1.toLowerCase(); }
            if (_.isString(itemField2)) { itemField2 = itemField2.toLowerCase(); }
...
export class ODataQuery {
    ...
    constructor(options?: any) {
        ...
        this.pageNum = utils.createObservable<number>(options.pageNum);
        this.pageSize = utils.createObservable<number>(options.pageSize);
    ...
    public orderby(field: any, ascending?: any): ODataQuery {
        var order = this.ordersby.find(order => order.field() === ko.unwrap(field));
        if (order) {
    ...
    public toLocalFilter(): (item) => boolean {
        ...
        if (this.includeDeleted() !== true) {
            filters.push((e) => !ko.unwrap(e.IsRemoved));
            filters.push(operator.and);
        }
